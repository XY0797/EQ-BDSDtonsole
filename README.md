...
#### EQ面板采用分体式设计，如图，BDS启动器负责启动BDS、传达面板指令，面板作为“大脑”控制BDS启动器

#### 启动器代码已经固定了，面板的更新基本上支持免停服
...
### 4. 本项目使用了zyJson封装的json模块，用于处理json数据 **(注：未找到该作者的联系方式)**
...
Copyright © 2022 [XY0797](https://github.com/XY0797)
