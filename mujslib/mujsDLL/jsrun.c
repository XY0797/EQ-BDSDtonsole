...
static void jsR_callcppfunction(js_State* J, int n, int min, js_CPPFunction F)
{
	int i;
	js_Value v;
...
void js_call(js_State *J, int n)
{
	...
	if (obj->type == JS_CFUNCTION) {
		...
		if(obj->u.c.CPPfunction){ jsR_callcppfunction(J, n, obj->u.c.length, obj->u.c.CPPfunction); }else{ jsR_callcfunction(J, n, obj->u.c.length, obj->u.c.function); }
		--J->tracetop;
	}
