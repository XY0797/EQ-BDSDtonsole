...
void js_newcppfunction(js_State* J, js_CPPFunction fun, const char* name, int length);
void js_newcppfunctionx(js_State* J, js_CPPFunction fun, const char* name, int length, void* data, js_Finalize finalize);
